...
class RPGC_Settings extends WC_Settings_Page {
	...
	public function get_sections() {
		...
		$sections = apply_filters( 'woocommerce_add_section_giftcard', array( 
			'' 			=> __( 'Options', 'rpgiftcards' ),
			'uses' 		=> __( 'Usage', 'rpgiftcards' ),
			'emails' 	=> __( 'Emails', 'rpgiftcards' ),
			'labels' 	=> __( 'Labels', 'rpgiftcards' ) 
		));
	...
	public function get_settings( $current_section = '' ) {
		...
		if( $current_section == '' ) {
		...
		} else if( $current_section == 'uses') {

			$options = apply_filters( 'woocommerce_giftcard_uses_settings', array(

				array( 'title' 		=> __( 'Gift Card Usage',  'rpgiftcards'  ), 'type' => 'title', 'id' => 'giftcard_uses_title' ),
		...
		} else if( $current_section == 'emails') {

			$options = apply_filters( 'woocommerce_giftcard_email_settings', array(
			...
			$options = apply_filters( 'woocommerce_giftcard_label_settings', array(

				array( 'title' 		=> __( 'Labels',  'rpgiftcards'  ), 'type' => 'title', 'id' => 'giftcard_products_options_title' ),
